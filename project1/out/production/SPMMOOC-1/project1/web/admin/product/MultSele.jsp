	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
					...
					<c:forEach items="${mult.recordSum}" var="product">
						<tr>
							...
							<td height="20" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=deleteOne&pid=${product.pid}">删除</a> |
									<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findCategoryByUpdate&pid=${product.pid}">编辑</a>
								</div>
							</td>
					</tr>
					</c:forEach>
					...
					<tr>
						<td width="33%"><div align="left">
								<span class="STYLE22">&nbsp;&nbsp;&nbsp;&nbsp;共有<strong>
										${mult.totalRecordsNum}</strong> 条记录，当前第<strong>${mult.currentPageNum }</strong> 页，共 <strong>${mult.totalPageNum }</strong> 页</span>
							</div>
						</td>
						<td width="67%">
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=multSelect&num=1">首页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=multSelect&num=${mult.prevPageNum}">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=multSelect&num=${mult.nextPageNum}">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/admin/ProductServlet?op=multSelect&num=${mult.totalPageNum }">尾页</a></span>
										</div>
									</td>
									...
									<td width="22">
										<div align="center">
											<input type="text" name="num" id="num" value="${mult.currentPageNum }" style="width:20px; height:12px; font-size:12px; border:solid 1px #7aaebd;" />
										</div>
									</td>
