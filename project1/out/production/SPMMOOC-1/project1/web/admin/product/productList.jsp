...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
					...
					<c:forEach items="${productList.recordSum}" var="product">
						<tr>
					...
					<tr>
						<td width="33%"><div align="left">
								<span class="STYLE22">&nbsp;&nbsp;&nbsp;&nbsp;共有<strong>
										${productList.totalRecordsNum }</strong> 条记录，当前第<strong>${productList.currentPageNum }</strong> 页，共 <strong>${productList.totalPageNum }</strong> 页</span>
							</div>
						</td>
						<td width="67%">
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findAllProduct&num=${productList.prevPageNum}">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findAllProduct&num=${productList.nextPageNum}">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findAllProduct&num=${productList.totalPageNum }">尾页</a></span>
										</div>
									</td>
									...
									<td width="22">
										<div align="center">
											<input type="text" name="num" id="num" value="${productList.currentPageNum }" style="width:20px; height:12px; font-size:12px; border:solid 1px #7aaebd;" />
										</div>
									</td>
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			if (num > ${productList.totalPageNum}) {
				alert("页码超出范围");
				return;
			}
