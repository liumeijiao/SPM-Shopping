...
<html>
	...
	<body>
	 <form method="post" action="${pageContext.request.contextPath }/admin/ProductServlet?op=updateProduct&imgurl=${product.imgurl}" enctype="multipart/form-data">
				 ...
				 <tr>
					 ...
					 <tr>
						...
						<td width="80%" height="20" bgcolor="d3eaef" class="STYLE6"><div
						     ...
						     <textarea name="description" cols="80" rows="5" >${product.descp}</textarea>
